...
urlpatterns = [
    ...
    path("users/update/<str:pk>", users.inativar_user_view),
    path("users/delete/<str:pk>", users.ativar_user_view),
    path("users/inativar/<str:pk>", users.update_user_view),
    path("users/ativar/<str:pk>", users.delete_user_view),
